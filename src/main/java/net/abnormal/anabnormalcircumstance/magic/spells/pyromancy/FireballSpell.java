...
public class FireballSpell extends Spell {
    public FireballSpell(Identifier id, Identifier icon) {
        super(id, SpellElement.PYROMANCY, SpellTier.TIER_3, 35, 60, icon, "Fireball", "Fires a fast explosive fireball that deals high damage on direct impact.");
    }
    ...
    public boolean cast(ServerPlayerEntity caster) {
        ...
        FireballEntity fireball = new FireballEntity(world, caster, look.x, look.y, look.z, 4);
