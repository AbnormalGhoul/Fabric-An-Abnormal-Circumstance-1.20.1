...
public class PyroclasmWaveSpell extends Spell {
    ...
    public PyroclasmWaveSpell(Identifier id, Identifier icon) {
        super(id, SpellElement.PYROMANCY, SpellTier.TIER_3, 50, 90, icon, "Pyroclasm Wave", "Creates expanding rings of fire at your feet that damage enemies close to you.");
    }
