...
public class WillBreakerItem extends SwordItem implements UniqueAbilityItem {
    ...
    public void useUniqueAbility(PlayerEntity player) {
        ...
        for (LivingEntity target : targets) {
            target.damage(world.getDamageSources().magic(), 35.0F);
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        ...
        tooltip.add(Text.literal("Active: Inferno Strike - unleash a fiery blast dealing 35 damage").formatted(Formatting.GOLD));
