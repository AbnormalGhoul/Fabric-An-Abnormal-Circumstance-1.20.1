...
public class SilverArrowItem extends ArrowItem {
    ...
    public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(Text.literal("A finely crafted arrow with a gleaming silver head"));
        tooltip.add(Text.literal("Imbued with purity that pierces the foul essence of the undead"));
        tooltip.add(Text.literal("Deals 33% more damage to Undead creatures"));
